...
class TestAwstaga(unittest.TestCase):
    ...
    def test_apply(  # pylint: disable=too-many-arguments
        self, func_init, func_load, func_client, func_sleep
    ):
        ...
        func_load.return_value = ({"sometagsetname": mock_tagset}, [mock_resource])
        ...
        mock_logger.info.assert_has_calls(
            [
                ...
                call(
                    "Adding resource somearn to a batch with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
                call(
                    "Applying 1 resource(s) with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
            ]
        )
    ...
    def test_apply_with_enabled_dry_run(  # pylint: disable=too-many-arguments
        ...
        apply(conf_file="awstaga.yaml", dry_run=True, batch_size=5, delay=2)
    ...
    def test_apply_with_batch_size_2(  # pylint: disable=too-many-arguments
        ...
        mock_logger.info.assert_has_calls(
            [
                call("Loading configuration file awstaga.yaml"),
                call(
                    "Adding resource somearn1 to a batch with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
                call(
                    "Adding resource somearn2 to a batch with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
                call(
                    "Applying 2 resource(s) with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
                call(
                    "Adding resource somearn3 to a batch with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
                call(
                    "Adding resource somearn4 to a batch with tags "
                    "{'sometagkey': 'sometagvalue', 'someresourcekey': 'someresourcevalue'}"
                ),
                call(
                    "Applying 2 resource(s) with tags "
        ...
        mock_client.tag_resources.assert_has_calls(
            [
                call(
                    ResourceARNList=["somearn1", "somearn2"],
                    Tags={
                ...
                call(
                    ResourceARNList=["somearn3", "somearn4"],
                    Tags={
                        "sometagkey": "sometagvalue",
                        "someresourcekey": "someresourcevalue",
                    },
        ...
        func_sleep.assert_has_calls([call(2), call(2)])
    ...
    def test_apply_with_error(  # pylint: disable=too-many-arguments
        ...
        apply(conf_file="awstaga.yaml", dry_run=False, batch_size=5, delay=2)
    ...
    @patch("awstaga.apply")
    def test_cli(self, func_apply):  # pylint: disable=too-many-arguments
